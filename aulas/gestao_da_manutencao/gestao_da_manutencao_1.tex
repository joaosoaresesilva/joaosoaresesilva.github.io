...
% --- BLOCO DE PREÂMBULO UNIVERSAL (Compatível com TeX Live) ---
\usepackage[a4paper, top=2.5cm, bottom=2.5cm, left=2cm, right=2cm]{geometry}
\usepackage[T1]{fontenc}
\usepackage[utf8]{inputenc}
\usepackage[portuguese]{babel}

% Utilização de fontes padrão do TeX Live (Helvetica e Times)
% O pacote helvet é parte da coleção básica do TeX Live
...
% Hyperref deve ser o último a ser carregado
